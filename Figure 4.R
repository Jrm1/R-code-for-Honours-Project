...
par(mfrow=c(1,1))
plot(t[0:75]~r[0:75], ylab="",xlab="",xlim=c(0,0.4),ylim=c(0.02,0.2),yaxt="n",xaxt="n",lty="dotted",type="l",col="black")
par(new=TRUE)
plot(t[75:501]~r[75:501], ylab="",xlab="",xlim=c(0,0.4),ylim=c(0.02,0.2),yaxt="n",xaxt="n",type="l",col="blue",lwd="2")
points(sigmav,muv,pch=19)
#abline(coef(line(m~s)),type="l",lty="dotted")
abline(coef(line(m1~s1)),type="l",col="blue",lty="solid",lwd="2")
abline(coef(line(m2~s2)),type="l",lty="dotted")
points(sigma[1],mu[1],pch=19,col="black",lty="dotted")
...
mtext("Figure 4: Efficient frontiers",pos = 3,cex=1)
